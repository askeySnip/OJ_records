...
class MilkConsumption {
 public:
  vector<int> findMaxRegion(vector<int> population,
                            vector<int> totalConsumption) {
    int id = 0;
    double m = -1;
    REP(i, 0, population.size()) {
      double t = totalConsumption[i] * 1.0 / population[i];
      if (t > m) {
        id = i;
        m = t;
      }
 ...
 private:
  ...
  void test_case_0() {
    ...
    verify_case(0, Arg2, findMaxRegion(Arg0, Arg1));
  }
  void test_case_1() {
    ...
    int Arr2[] = {0};
    vector<int> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
    verify_case(1, Arg2, findMaxRegion(Arg0, Arg1));
  }
  void test_case_2() {
    ...
    int Arr2[] = {0, 2};
    vector<int> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
    verify_case(2, Arg2, findMaxRegion(Arg0, Arg1));
  }
  void test_case_3() {
    ...
    int Arr2[] = {1};
    vector<int> Arg2(Arr2, Arr2 + (sizeof(Arr2) / sizeof(Arr2[0])));
    verify_case(3, Arg2, findMaxRegion(Arg0, Arg1));
  }
